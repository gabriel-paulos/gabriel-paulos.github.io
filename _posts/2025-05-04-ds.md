...
In many ways this resembles the MapReduce program found in distributed systems. Except the function used for mapping are LLMs and the similarly the reduce function (the aggregator) is also an LLM. 
